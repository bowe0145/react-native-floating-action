...
class FloatingAction extends Component {
  ...
  renderMainButton() {
      ...
      transform: [
        {
          rotate: this.visibleAnimation.interpolate({
            ...
            outputRange: [
              "0deg",
              animationDegrees.visibility.toString() + "deg"
            ]
          })
        },
        {
      ...
      transform: [
        {
          rotate: this.animation.interpolate({
            inputRange: [0, 1],
            outputRange: ["0deg", animationDegrees.press.toString() + "deg"]
          })
        }
      ]
    };
    ...
    return (
      <Animated.View
        style={[
          StyleObject.buttonContainer,
          StyleObject[`${position}Button`],
          propStyles,
          animatedVisibleView
        ]}
        accessible={true}
      ...
      >
        ...
        >
          <Animated.View
            style={[StyleObject.buttonTextContainer, animatedViewStyle]}
          >
            {this.getIcon()}
          </Animated.View>
        </Touchable>
  ...
  renderActions() {
    ...
    if (active) {
      actionsStyles.push(StyleObject[`${position}ActionsVisible`]);
    }
  ...
  renderTappableBackground() {
    ...
    return (
      <TouchableOpacity
        activeOpacity={1}
        style={[StyleObject.overlay, { backgroundColor: overlayColor }]}
  ...
  render() {
    ...
    return (
      <Animated.View
        ...
        style={[StyleObject.overlay, { backgroundColor: "transparent" }]}
      >
...
FloatingAction.propTypes = {
  ...
  animationDegrees: PropTypes.shape({
